...
let dynamicCall (inst:obj) name (arg:'T) : 'R =
...
let (?) (inst:obj) name (arg:'T) : 'R = dynamicCall inst name arg
  
type DynamicTypeWrapper() =
    static member dynamicCall (inst:obj) name (arg:'T) : 'R = dynamicCall inst name arg